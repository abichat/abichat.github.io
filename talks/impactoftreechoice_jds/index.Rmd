...
But hundreds of taxa in a single study...
...
`r emo::ji("muscle")` Is it possible to do better?


---
## Incorporate taxonomy in the analysis?

.footnote[`r emo::ji("page_facing_up")` Philippot et al. (2010), Koeppel & Wu (2012)]
...
`r emo::ji("grinning_face")` The correlation tree is different from the taxonomy
