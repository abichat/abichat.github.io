...
df <- tibble(
  col1 = c("", "", "Prediction", "Prediction"),
  col2 = c("", "", "Predicted positive", "Predicted negative"),
...
df %>%
  ...
  bg(i = 2, j = 3:4, bg = alpha("grey", 0.2)) %>%
  bg(i = 3:4, j = 2, bg = alpha("grey", 0.2)) %>%
  bg(i = 3, j = 3, bg = alpha("green", 0.5)) %>%
  bg(i = 4, j = 4, bg = alpha("green", 0.5)) %>%
  bg(i = 3, j = 4, bg = alpha("red", 0.5)) %>%
  bg(i = 4, j = 3, bg = alpha("red", 0.5)) %>%
  hline(i = 1, j = 3:4, border = fp_border(width = 2)) %>%
  hline(i = 2, j = 2, border = fp_border(width = 2)) %>%
  hline(i = 2, j = 3:4, border = fp_border(width = 1)) %>%
  hline(i = 3, j = 2:4, border = fp_border(width = 1, style = "dashed")) %>%
  hline(i = 4, j = 2:4, border = fp_border(width = 2)) %>%
  vline(i = 3:4, j = 1, border = fp_border(width = 2)) %>%
  vline(i = 2, j = 2, border = fp_border(width = 2)) %>%
  vline(i = 3:4, j = 2, border = fp_border(width = 1)) %>%
  vline(i = 2:4, j = 3, border = fp_border(width = 1, style = "dashed")) %>%
  vline(i = 2:4, j = 4, border = fp_border(width = 2)) %>%
  fontsize(size = 20)  %>% 
  height_all(0.5)
```
...
Denote by $\mathbf{z}$ the vector of observed _z_-values and $\mathbf{\mu}$ the vector of "true" _z_-values
...
$$\text{Mean z-smoothing} = |z_{\text{raw}} - z_{\text{corrected}}|$$
...
.footnote[`r emo::ji("page_facing_up")` Bastide et al. (2016)]
