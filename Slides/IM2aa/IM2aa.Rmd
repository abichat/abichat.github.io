...
.pull_right[
```{r plotpubli, echo=FALSE, out.width="50%"}
print(p)
```
]
...
Sous l'hupothèse nulle, $p\sim\mathcal{U}\left([0,1]\right)$, donc avec un seuil $\alpha = 0.05$, on a 5% de chance de faire une "fausse découverte".
...
```{r dfpval, echo=FALSE, fig.height=4, fig.align='center'}
