...
<ul>
<li><p>Délégué</p></li>
<li><p>Élève Administrateur</p></li>
</ul>
</ul>
...
* Voeux de 3A hors-école
  ...
  * _Mathématiques de la Modélisation_, UPMC 
...
* Apports :
  ...
  * Interaction avec des informaticiens, biologistes, médecins, ...
...
* Le **métagénome** (**microbiome** en anglais) est l'ensemble des génomes du microbiote 
...
---
## Quelques chiffres sur le microbiote intestinal

* 100 000 milliards de micro-organismes

* Entre 100 000 et 800 000 gènes (contre 23 000 chez l'Homme)
 
* En moyenne, 350 espèces différentes dans un individu

* 2 kilos (contre 1,5 kg pour le cerveau humain)
...
* Olfaction et préférences alimentaires
...
<center>
  <iframe width="672" height="378" src="https://www.youtube.com/embed/5DTrENdWvvM" frameborder="0" allowfullscreen></iframe>
</center>
...
* 700 employés dont une trentaine de stagiaires
...
* Apports :
  ...
  * Programmation R (et un peu Shell)
...
```{r diet, fig.align="center", out.width="90%", echo=FALSE}
knitr::include_graphics("mixedplot.png") 
```
...
.pull-right[
```{r pic1, fig.align="center", out.width="100%", echo=FALSE}
knitr::include_graphics("Pic1.jpg") 
```

```{r pic2, fig.align="center", out.width="100%", echo=FALSE}
...
* Convention Individuelle de Formation par la Recherche


```{r cifre, fig.align="center", out.width="80%", echo=FALSE}
knitr::include_graphics("ANRT.png")
``` 
...
* Double encadrement et bi-culturalité

* Pas de restriction sur le secteur d'acivité de l'entreprise

* Dépot des dossiers toute l'année

---
## Quelques chiffres

* Salaire moyen brut annuel de 29 000 € 

* Taux de soutenance > 90 %

* 48 % des doctorants ont un diplôme d'ingénieur

* 1/3 des doctorants restent dans l'entreprise à la fin de la CIFRE

<br>

Plus d'information sur le <a href="http://www.anrt.asso.fr/fr/cifre-7843" target="_blank">site</a> du dispositif CIFRE.
...
```{r pval, fig.align="center", out.width="50%", echo=FALSE}
knitr::include_graphics("pvalmeme.jpg")
```

---
## Définition et utilisation

Soit $H_0$ une hypothèse nulle et $X$ une série d'observations. La p-valeur est
...
Sous l'hypothèse nulle $p\sim\mathcal{U}\left([0,1]\right)$. Avec un seuil $\alpha = 0.05$, on a donc 5% de chance de faire une "fausse découverte" (faux positif). 
...
$$\mathbb{E}\left[\frac{\text{nombre de fausses découvertes}}{\text{nombre de découvertes}  \ \wedge \ 1}\right].$$
...
```{r msante, fig.align="center", out.width="80%", echo=FALSE}
knitr::include_graphics("Visu_Mines_Sante.jpg")
```

---
# Mines Santé

* Club professionnel des alumnis des trois Écoles des Mines intéressés par le domaine de la Santé

* Dispositifs médicaux, laboratoires pharmaceutiques, gestion hospitalière, biotechs, medtechs, e-santé, ...
...
.center[
__Soirée de lancement__

La santé en 2030, quelles sont les innovations qui feront la santé de demain ? 

Mardi 20 mars - 19h00-21h30

Maison des Mines - Paris 5ème
